<template>
    <div id="fancybox" class="popup_wrapper" v-if="$store.state.fancybox.status">
        <div class="popup">
            ...
            <div class="clearfix">
                <a href="#" v-if="image" class="switch_button_previous icon-single_arrow_left" :title="label('previous')"  v-on:click.prevent="previous"></a>
                ...
                <a href="#" v-if="image" class="switch_button_next icon-single_arrow_right" :title="label('next')" v-on:click.prevent="next"></a>
            </div>
        </div>
    </div>
</template>
