<template>
    ...
    <div class="grid-item_language-support">
        <router-link v-for="language in languages" v-bind:to="{name: 'home', params: {lang: language}}" v-bind:key="language" active-class="active" v-bind:class="['flag', language]"></router-link>
    </div>
    <!-- end switch language -->
</template>
